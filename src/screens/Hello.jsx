  ...
  <SafeAreaView className="flex-1 bg-black">
    <ImageBackground className="flex-1 bg-black" source={leafBackground} resizeMode="cover">
      <View className="flex-1 items-center justify-center mx-6">
        ...
        <Text className="font-inter text-white text-center text-base mx-4 mt-1 mb-6">Esta pronto para se tornar um mateiro? crie sua conta e começe agora mesmo!</Text>
